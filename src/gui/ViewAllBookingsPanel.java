...
public class ViewAllBookingsPanel extends JPanel {
    ...
    private JPanel createStatsPanel() {
        ...
        panel.add(createStatCard("Total Revenue", "₹0.00", UIStyles.WARNING_COLOR));
    ...
    private void loadBookings() {
        ...
        if (statsPanel instanceof JPanel) {
            ...
            panel.add(createStatCard("Total Revenue", String.format("₹%.2f", totalRevenue), UIStyles.WARNING_COLOR));
            panel.revalidate();
            panel.repaint();
        }
    }
