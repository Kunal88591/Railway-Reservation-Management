...
public class ReportsPanel extends JPanel {
    ...
    private JPanel createOverallStatsPanel() {
        ...
        panel.add(createStatCard("Total Revenue", String.format("₹%.2f", totalRevenue), UIStyles.DANGER_COLOR));
    ...
    private JPanel createBookingStatsPanel() {
        ...
        stats.append("  • Average Booking Value: ₹").append(String.format("%.2f", avgBookingValue));
    ...
    private JPanel createRevenuePanel() {
        ...
        stats.append("Today's Revenue: ₹").append(String.format("%.2f", todayRevenue)).append("\n\n");
        stats.append("Revenue by Payment Method:\n");
        revenueByPayment.forEach((method, revenue) -> 
            stats.append("  • ").append(method).append(": ₹")
